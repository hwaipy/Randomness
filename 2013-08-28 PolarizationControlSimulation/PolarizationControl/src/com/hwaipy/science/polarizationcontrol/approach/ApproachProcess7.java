...
public class ApproachProcess7 {
    ...
    public ApproachProcess7.ApproachResult approach() {
        logging(0, "Start Approching", false);
        logging(0, "", true);
        int left = rotate();
        logging(0, "End Approching", false);
        logging(0, "", true);
        return new ApproachProcess7.ApproachResult(left > 0,
    ...
    public static void main(String[] args) {
        ApproachProcess7 p = new ApproachProcess7();
        p.loggingLevel = -1;
        int count = 0;
        int overallCount = 0;
        int successCount = 0;
        ...
        for (int i = 0; i < 10000; i++) {
            ...
            ApproachProcess7.ApproachResult result = p.approach();
            overallCount++;
            if (result.success) {
                successCount++;
