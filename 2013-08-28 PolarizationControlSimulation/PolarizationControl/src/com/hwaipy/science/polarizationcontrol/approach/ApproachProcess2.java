...
public class ApproachProcess2 {
    ...
    public ApproachProcess2.ApproachResult approach() {
        logging(0, "Start Approching", false);
        logging(0, "", true);
        int left = rotate();
        logging(0, "End Approching", false);
        logging(0, "", true);
        return new ApproachProcess2.ApproachResult(left > 0,
...
//        }
     ...
     * Total: 10000
     * Success: 6918
     * MeanStep: 235.61824226655102
     * @param args
     */
    public static void main(String[] args) {
        ApproachProcess2 p = new ApproachProcess2();
        p.loggingLevel = -1;
        int count = 0;
        int overallCount = 0;
        int successCount = 0;
        ...
        for (int i = 0; i < 10000; i++) {
            ...
            ApproachProcess2.ApproachResult result = p.approach();
            overallCount++;
            if (result.success) {
                successCount++;
