...
//        System.out.println(fiberTransformTheta1 / Math.PI * 180);
//        System.out.println(fiberTransformTheta2 / Math.PI * 180);
//        System.out.println(fiberTransformTheta3 / Math.PI * 180);
...
//        }
    ...
    public static void main(String[] args) {
        ApproachProcess p = new ApproachProcess();
        p.loggingLevel = -1;
        int count = 0;
        while (true) {
            p.generateRandomFiberTransform();
//            p.setFiberTransform(-45.7595698944864 / 180 * Math.PI, -59.927069376912534 / 180 * Math.PI, -22.496651984348983 / 180 * Math.PI);
            ApproachProcess.ApproachResult result = p.approach();
            System.out.println(result.success);
//            System.out.println(result.stepCount);
//            break;
//            System.out.println(result.cH + ",   " + result.cD);
            count++;
//            if (count % 1000 == 0) {
