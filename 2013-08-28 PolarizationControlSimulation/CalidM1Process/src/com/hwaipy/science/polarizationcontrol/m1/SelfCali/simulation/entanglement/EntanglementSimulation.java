...
public class EntanglementSimulation {
    ...
    public EntanglementSimulation(MeasurementFactory measurementFactory, ErroredTwoPhotonStateFactory twoPhotonStateFactory) {
        this.random = new Random(0);
        model = new EntanglementModel(twoPhotonStateFactory);
        m6PC = new EntanglementPolarizationControl(new M6EntanglementMeasurementProcess(measurementFactory));
        m24PC = new EntanglementPolarizationControl(new M24EntanglementMeasurementProcess(measurementFactory));
    }
...
//        System.out.println(control);
    ...
    public static void main(String[] args) {
        ...
        ErroredTwoPhotonStateFactory twoPhotonStateFactory = new ErroredTwoPhotonStateFactory(0.2, 0.0);
        EntanglementSimulation simulation = new EntanglementSimulation(measurementFactory, twoPhotonStateFactory);
        Stat stat6 = new Stat();
