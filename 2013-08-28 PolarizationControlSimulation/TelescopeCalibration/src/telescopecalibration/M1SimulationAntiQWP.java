 ...
 * @author HwaipyLab
 */
public class M1SimulationAntiQWP {

    public M1SimulationAntiQWP() {
    }
...
//      System.out.print(cH + "\t" + cD + "\t");
    ...
    public static void main(String[] args) {
        ...
        M1SimulationAntiQWP s = new M1SimulationAntiQWP();
//    s.generateRandomTelescopeTransform();
//    M1SimulationResult result = s.calculate(20 + 32.75, 45);
        M1SimulationResult result = s.calculate(rH, rV, phase, rotate, false, false, 0);
