...
public class QPQIDrawer {
    ...
    private static final Color COLOR_LEFT = new Color(5, 5, 5);
    private static final Color COLOR_RIGHT = new Color(120, 120, 120);
    private static final Color COLOR_RIVER = new Color(240, 240, 240);
    private static final Color COLOR_RING = new Color(200, 200, 200);
