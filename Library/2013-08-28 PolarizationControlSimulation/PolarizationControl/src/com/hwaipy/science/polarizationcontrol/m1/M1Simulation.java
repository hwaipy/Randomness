...
//            if (Math.abs(result.cH) < 1e10 || Math.abs(result.cD) < 1e10) {
//                System.out.println(result.fiberTheta1);
//                System.out.println(result.fiberTheta2);
//                System.out.println(result.fiberTheta3);
//                return;
//            }
