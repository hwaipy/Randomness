...
public class CorrelationTest {
    ...
    private static final double minOmigaS = 805;
    private static final double maxOmigaS = 815;
    private static final double minOmigaI = 805;
    private static final double maxOmigaI = 815;
