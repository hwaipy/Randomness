 ...
 * @author Hwaipy
 */
public class ChannelMarkeredTimeEventList implements TimeEventList {
    ...
    public ChannelMarkeredTimeEventList(TimeEventList list, TimeEventList marker, int markerChannel) {
        this.list = list;
