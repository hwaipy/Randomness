...
public class APP_1 {
    ...
    //数据文件的目录
    private static final File dir = new File("/Users/Hwaipy/desktop/data/");
    //数据文件的扩展名
    //   private static final String ext = "ht2";
    private static final String ext = "ph400";
    //单次处理容量B
    ...
    private static final int DELAY_STOP = 8000;
    private static final int SCAN_HALF_GATE = 100;
    private static final int SCAN_STEP_LENGTH = 200;

    //任务2：4体
    private static final int DELAY_T1_I1 = 3200;
    private static final int DELAY_T1_I2 = -4800;
    private static final int DELAY_T2_I1 = 9600;
    private static final int DELAY_T2_I2 = 1600;
