...
public class PXIDataParse {
    ...
    public static void main(String[] args) throws IOException, DeviceException {
        File file = new File("/Users/Hwaipy/Documents/Dropbox/LabWork/实验/2013-12-03 光秒恢复状态采数/2014-03-25 双TDC同步测试/20140330202432TDC.dat");
        ...
        long[] calibrationMap = calibrationCreator.calibrationMap(0);
