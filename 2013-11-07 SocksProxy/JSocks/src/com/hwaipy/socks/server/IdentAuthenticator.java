package com.hwaipy.socks.server;

import com.hwaipy.socks.InetRange;
import com.hwaipy.socks.ProxyMessage;
...
public class IdentAuthenticator extends ServerAuthenticatorNone {
     ...
     * @param user Username associated with this connection,could be null if
     ...
     * to indicate that anybody is allowed to connect from the hosts within
     * given range.
     */
