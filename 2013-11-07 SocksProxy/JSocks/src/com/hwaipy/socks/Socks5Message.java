...
class Socks5Message extends ProxyMessage {
     ...
     * @throws SocksException If server response code is not SOCKS_SUCCESS(0),
     * or if any error with protocol occurs.
     ...
     * @throws SocksException If server response code is not SOCKS_SUCCESS(0)
     * and reading in client mode, or if any error with protocol occurs.
     * @throws IOException If any error happens with I/O.
     */
