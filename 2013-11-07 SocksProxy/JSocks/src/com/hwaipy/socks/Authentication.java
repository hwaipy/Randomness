...
public interface Authentication {
     ...
     * should be used on this connection. Third argument is optional and should
     * contain an instance of UDPEncapsulation. It should be provided if the
     * authentication method used requires any encapsulation to be done on the
     * datagrams.
     */
