...
import com.hwaipy.socks.Socks5DatagramSocket;
 ...
 * Reads input line by line and sends it to given on command line host and port,
 * using given proxy, then blocks until reply datagram recieved, not really
 * echo, single threaded client, I just used it for testing before UDP actually
 * worked.
 */
