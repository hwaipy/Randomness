...
public class CorrelationTest {
    ...
    private static final double minOmigaS = 778;
    private static final double maxOmigaS = 782;
    private static final double minOmigaI = 778;
    private static final double maxOmigaI = 782;
